        ...
        <div className="container mx-auto px-6">
          ...
          <div className="w-full max-w-7xl mx-auto hidden md:block">
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(45deg, #231F20 0%, #231F20 5%, #001A7A 20%, #001A7A 40%, #231F20 65%, #231F20 100%)",
                width: "100%",
                maxWidth: "1320px",
                height: "659px",
                borderRadius: "32px",
            ...
            >
              <div className="flex justify-between h-full">
                ...
                <div
                  className="flex flex-col justify-start relative pr-8"
                  style={{ width: "40%", paddingTop: "0px" }}
                >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <div className="flex items-center mb-2">
                        <img
                          src="/images/NewMain/ContactForm/Person.svg"
                          alt="Person icon"
                    ...
                    <div>
                      <div className="flex items-center mb-2">
                        <img
                          src="/images/NewMain/ContactForm/Phone.svg"
                          alt="Phone icon"
                          className="w-5 h-5 mr-3"
                        />
                    ...
                    <div>
                      <div className="flex items-center mb-2">
                        <img
                          src="/images/NewMain/ContactForm/Work outline.svg"
                          alt="Work icon"
                          className="w-5 h-5 mr-3"
                        />
                        <label className="text-white text-sm">
                    ...
                    <div>
                      <div className="flex items-center mb-2">
                        <img
                          src="/images/NewMain/ContactForm/Email.svg"
                          alt="Email icon"
                          className="w-5 h-5 mr-3"
                        />
                        <label className="text-white text-sm">
